...
buff_bullet_d_image = pyglet.resource.image("buff_bullet_d.png")
center_image(buff_bullet_d_image)
buff_bullet_s_image = pyglet.resource.image("buff_bullet_s.png")
center_image(buff_bullet_s_image)
...
buff_enemy_l_image = pyglet.resource.image("buff_enemy_l.png")
center_image(buff_enemy_l_image)
...
buff_shield_c_image = pyglet.resource.image("buff_shield_c.png")
center_image(buff_shield_c_image)
...
bg_2_image = pyglet.resource.image("bg_2.png")
center_image(bg_2_image)
