...
def get_enemy(time,difficulty,enemy_list):
	...
	if difficulty == 1:		#
		...
		if time >= 600 and time % 300 == 0:		###comes in after 20 secs and reappears every 10 seconds
			enemy_list.append(enemy.Enemy_6())
			enemy_list.append(enemy.Enemy_7())	

		if time >= 900 and time % 450 == 0:	###comes in after 30 seconds and reappears every 15 seconds
